            ...
            <div className="w-full px-4 lg:w-8/12">
              <div>
                ...
                <div>
                  ...
                  El Chaco Paraguayo ofrece una intensa aventura, recorrerás kilómetros en camionetas 4x4 en busca de huellas y señales de actividad en nuestros diferentes destinos por estas áreas naturales puede ser una experiencia enriquecedora. Imagina recorrer caminos rodeados de vegetación exuberante, animales silvestres, avistando aves coloridas y, con suerte, observando la majestuosidad de un yaguareté en su hábitat. Sin embargo, es crucial que estos paseos se realicen de manera responsable, sin perturbar a los animales ni dañar el entorno. Así, podemos disfrutar de la belleza natural mientras contribuimos a su preservación. En un esfuerzo por concientizar sobre la importancia de la fauna y flora, debemos comprender su papel vital en los ecosistemas. Los animales merecen protección en su hábitat natural. 
                  </p>
                  <div className="mb-10 w-full overflow-hidden rounded">
                    <div className="relative aspect-[97/60] w-full sm:aspect-[97/44]">
                      <Image
                        src="/images/safaripage.jpg"
                        alt="image"
                        fill
